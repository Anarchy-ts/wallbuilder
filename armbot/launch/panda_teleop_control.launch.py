...
def generate_launch_description():
    ...
    pkg_share = launch_ros.substitutions.FindPackageShare(package='armbot').find('armbot')
    panda_ros2_gazebo_pkg_share = launch_ros.substitutions.FindPackageShare(package='armbot').find('armbot')
    ...
    panda_teleop_node = launch_ros.actions.Node(
        package='armbot',
        # namespace=...
        executable='panda_teleop_control.py',
        name='teleop_control',
        parameters=[
    ...
    spawn_entity = launch_ros.actions.Node(
        ...
        arguments=["-topic", "robot_description_visual", "-entity", "armbot"],
        output="screen",
    )

    return launch.LaunchDescription([
        launch.actions.DeclareLaunchArgument(name='armbot', default_value=default_model_path,
